...
class CornConfig(Config):
    """Configuration for training on AGCO Corn
    ...
    NUM_CLASSES = 1 + 4  # background + corn
...
class CornDataset(utils.Dataset):
    def load_corn(self, dataset_dir, subset, year=2022, class_ids=None,
                  return_coco=False):
        ...
        coco = COCO(
            "{}/annotations/corns_{}_{}.json".format(dataset_dir, subset, year))
        ...
        self.add_class("coco", 3, 'Mashed')
        self.add_class("coco", 5, 'Not broken')
        self.add_class("coco", 6, 'Nothing')
...
if __name__ == '__main__':
    ...
    if args.command == "train":
        ...
        dataset_val = CornDataset()
        val_type = "val"
        coco = dataset_val.load_corn(args.dataset, val_type, return_coco=True)
        dataset_val.prepare()
